...
__global__ void ColorSimilarityKernel(Color *d_img1, size_t pitch1, Color *d_img2, size_t pitch2, double *d_colorFeatures_r, size_t pitch_r, double *d_colorFeatures_g, size_t pitch_g, int width, int height);
